<nav>
			<ul>
				...
				<li class="principal">
					<a href="#"> <i class="far fa-clock"></i> Eventos</a>
					<ul>
					<?php
					if ($_SESSION['rol'] == 1) {
						# code...
				...
				?>
						<li><a href="registro_evento.php">Nuevo Evento</a></li>

						<?php }?>
						<li><a href="lista_eventos.php">Lista de Eventos</a></li>
					</ul>
				</li>
				...
				?>
						<li><a href="transacciones.php">Lista de Transaciones</a></li>
						<?php }?>
					</ul>
				</li>
